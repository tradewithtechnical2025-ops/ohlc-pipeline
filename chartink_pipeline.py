...
counts_backtest_scanners = {
    ...
    "1MH": "( {cash} (  daily high =  daily max( 20 ,  daily high ) and  daily close >  0 and  market cap >  10 ) )",
    "1ML": "( {cash} (  daily low =  daily min( 20 ,  daily low ) and  daily close >  0 and  market cap >  10 ) )",
